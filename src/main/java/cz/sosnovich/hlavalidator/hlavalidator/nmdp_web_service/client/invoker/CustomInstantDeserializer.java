...
public class CustomInstantDeserializer<T extends Temporal>
    ...
    public T deserialize(JsonParser parser, DeserializationContext context) throws IOException {
        ...
        switch (parser.getCurrentTokenId()) {
            case JsonTokenId.ID_NUMBER_FLOAT:
                return getJsonTokenIdIdNumberFloat(parser, context);

            case JsonTokenId.ID_NUMBER_INT:
                return getJsonTokenIdIdNumberInt(parser, context);

            case JsonTokenId.ID_STRING:
                return getJsonTokenIdString(parser, context);
            default:
    ...
    private T getJsonTokenIdIdNumberFloat(JsonParser parser, DeserializationContext context) throws IOException {
    ...
    private T getJsonTokenIdIdNumberInt(JsonParser parser, DeserializationContext context) throws IOException {
    ...
    private T getJsonTokenIdString(JsonParser parser, DeserializationContext context) throws IOException {
