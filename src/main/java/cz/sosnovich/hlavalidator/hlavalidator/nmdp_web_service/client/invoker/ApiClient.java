...
import cz.sosnovich.hlavalidator.hlavalidator.nmdp_web_service.client.invoker.auth.ApiKeyAuth;
import cz.sosnovich.hlavalidator.hlavalidator.nmdp_web_service.client.invoker.auth.Authentication;
import cz.sosnovich.hlavalidator.hlavalidator.nmdp_web_service.client.invoker.auth.HttpBasicAuth;
import cz.sosnovich.hlavalidator.hlavalidator.nmdp_web_service.client.invoker.auth.HttpBearerAuth;
...
@Component("cz.sosnovich.nmdp_web_service.client.invoker.ApiClient")
public class ApiClient {
    private boolean debugging = false;
    private HttpHeaders defaultHeaders = new HttpHeaders();
    private MultiValueMap<String, String> defaultCookies = new LinkedMultiValueMap<String, String>();
    private String basePath = "https://hml.nmdp.org/mac/api";
